...
export function GiftBox({ label, tagline, emoji, color, index, peekPreviews, onClick }: GiftBoxProps) {
  return (
    ...
    >
      ...
      <div className="absolute inset-[1px] rounded-2xl overflow-hidden box-shadow" style={{ zIndex: 1, background: 'rgba(255, 255, 255, 0.97)' }}>
        <div
          className="gift-bg"
          style={{
        ...
        <div className="relative z-10 flex flex-col items-center h-full p-6">
          <div className="flex-1 flex items-center justify-center w-full">
            <div className="transition-all duration-500 [transition-timing-function:cubic-bezier(0.05,0,0.7,1)] group-hover:-translate-y-52 group-hover:scale-110">
