    ...
    <AnimatePresence>
      {!dismissed && (
        <motion.div
          ...
          style={{
            background: 'linear-gradient(180deg, #0F172A 0%, #1D4ED8 35%, #3B82F6 65%, #93C5FD 100%)',
          }}
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          <motion.h1
            className="text-5xl sm:text-6xl md:text-7xl font-heading text-white mb-3 drop-shadow-[0_0_30px_rgba(147,197,253,0.3)]"
          ...
          <motion.p
            className="text-base sm:text-lg font-serif text-[#BFDBFE] mb-10"
          ...
          >
            ...
            >
              ...
              >
                <defs>
                  <linearGradient id="welcome-surf-grad" y2="100%" x2="50%" y1="0%" x1="50%">
                    <stop offset="0%" stopOpacity="1" stopColor="#3B82F6" />
                    <stop offset="100%" stopOpacity="1" stopColor="#1D4ED8" />
                  </linearGradient>
                </defs>
                <g transform="matrix(1,0,0,1,0,-91.0877685546875)" fill="url(#welcome-surf-grad)">
                  <path
                    opacity="0.05"
